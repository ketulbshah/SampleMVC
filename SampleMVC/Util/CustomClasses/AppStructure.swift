...
struct DeviceType {
    ...
    static let IPHONE5SE = UIDevice.current.userInterfaceIdiom == .phone && ScreenSize.MaxLength == 568.0
    static let IPHONE6AND7 = UIDevice.current.userInterfaceIdiom == .phone && ScreenSize.MaxLength == 667.0
    static let IPHONE6PAND7P = UIDevice.current.userInterfaceIdiom == .phone && ScreenSize.MaxLength == 736.0
